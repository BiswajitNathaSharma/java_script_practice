...
// a callback function that can be used to log the message at a later time.
  ...
  var person = {
    firstName: 'biswajit',
    lastName: 'natha sharma',
    age: 20
  };
  
  var callback = ageInDays(person);
  callback(); //The person's full name is biswajit natha sharma and their age is 7200


  
//function for concatnate and calculet the age in days
